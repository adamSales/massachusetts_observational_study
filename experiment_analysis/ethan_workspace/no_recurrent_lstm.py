...
for i in range(N_SPLITS):
    ...
    # Create model
    input_layer = Input(shape=prior_training_input[0].shape, name='prior')
    model = Dense(units=64, activation='tanh')(input_layer)
    ...
    combined_model.fit(x=prior_training_input,
    ...
    completion_testing_output, problem_count_testing_output = combined_model.predict(prior_testing_input)

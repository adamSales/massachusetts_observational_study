...
for i in range(N_SPLITS):
    ...
    combined_model = Model([recurrent_input_layer, prior_input_layer], [completion_output_layer, problem_count_output_layer])
    ...
    weights = {'completion': np.ones_like(completion_training_target) * 10, 'problem_count': completion_training_target}
    ...
    completion_testing_output, problem_count_testing_output = combined_model.predict({'recurrent': recurrent_testing_input, 'prior': prior_testing_input})

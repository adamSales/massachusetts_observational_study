...
ln(sum((assignment_actions.action_defn_type_id = 1)::int) + 1) as ln_action_1_count, 
ln(sum((assignment_actions.action_defn_type_id = 2)::int) + 1) as ln_action_2_count, 
ln(sum((assignment_actions.action_defn_type_id = 3)::int) + 1) as ln_action_3_count, 
ln(sum((assignment_actions.action_defn_type_id = 4)::int) + 1) as ln_action_4_count, 
ln(sum((assignment_actions.action_defn_type_id = 5)::int) + 1) as ln_action_5_count, 
ln(sum((assignment_actions.action_defn_type_id = 6)::int) + 1) as ln_action_6_count, 
ln(sum((assignment_actions.action_defn_type_id = 7)::int) + 1) as ln_action_7_count, 
ln(sum((assignment_actions.action_defn_type_id = 8)::int) + 1) as ln_action_8_count, 
ln(sum((assignment_actions.action_defn_type_id = 9)::int) + 1) as ln_action_9_count, 
ln(sum((assignment_actions.action_defn_type_id = 10)::int) + 1) as ln_action_10_count, 
ln(sum((assignment_actions.action_defn_type_id = 11)::int) + 1) as ln_action_11_count, 
ln(sum((assignment_actions.action_defn_type_id = 12)::int) + 1) as ln_action_12_count, 
ln(sum((assignment_actions.action_defn_type_id = 13)::int) + 1) as ln_action_13_count, 
ln(sum((assignment_actions.action_defn_type_id = 14)::int) + 1) as ln_action_14_count, 
ln(sum((assignment_actions.action_defn_type_id = 15)::int) + 1) as ln_action_15_count, 
ln(sum((assignment_actions.action_defn_type_id = 16)::int) + 1) as ln_action_16_count, 
ln(sum((assignment_actions.action_defn_type_id = 17)::int) + 1) as ln_action_17_count, 
ln(sum((assignment_actions.action_defn_type_id = 18)::int) + 1) as ln_action_18_count, 
ln(sum((assignment_actions.action_defn_type_id = 19)::int) + 1) as ln_action_19_count, 
ln(sum((assignment_actions.action_defn_type_id = 20 and coalesce(action_responses.correct, false))::int) + 1) as ln_action_20a_count, 
ln(sum((assignment_actions.action_defn_type_id = 20 and not coalesce(action_responses.correct, false))::int) + 1) as ln_action_20b_count, 
ln(sum((assignment_actions.action_defn_type_id = 21)::int) + 1) as ln_action_21_count, 
ln(sum((assignment_actions.action_defn_type_id = 22)::int) + 1) as ln_action_22_count, 
ln(sum((assignment_actions.action_defn_type_id = 23)::int) + 1) as ln_action_23_count, 
ln(sum((assignment_actions.action_defn_type_id = 24)::int) + 1) as ln_action_24_count, 
ln(sum((assignment_actions.action_defn_type_id = 25)::int) + 1) as ln_action_25_count, 
ln(sum((assignment_actions.action_defn_type_id = 26)::int) + 1) as ln_action_26_count, 
ln(sum((assignment_actions.action_defn_type_id = 27)::int) + 1) as ln_action_27_count, 
ln(sum((assignment_actions.action_defn_type_id = 28)::int) + 1) as ln_action_28_count, 
ln(sum((assignment_actions.action_defn_type_id = 29)::int) + 1) as ln_action_29_count, 
ln(sum((assignment_actions.action_defn_type_id = 30)::int) + 1) as ln_action_30_count, 
ln(sum((assignment_actions.action_defn_type_id = 31)::int) + 1) as ln_action_31_count, 
ln(sum((assignment_actions.action_defn_type_id = 32)::int) + 1) as ln_action_32_count, 
ln(sum((assignment_actions.action_defn_type_id = 33)::int) + 1) as ln_action_33_count, 
ln(sum((assignment_actions.action_defn_type_id = 34)::int) + 1) as ln_action_34_count, 
ln(sum((assignment_actions.action_defn_type_id = 35)::int) + 1) as ln_action_35_count 
...
avg((problem_logs.first_action_type_id=1)::int) as student_prior_average_answer_first, 
